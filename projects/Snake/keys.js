...
window.addEventListener("keyup",function(e){
	...
	if (char == "p" || char == "P"){
		if (app.gameState == app.GAMESTATE.pause){
			app.gameState = app.GAMESTATE.main;
		} else {
			app.gameState = app.GAMESTATE.pause;
		}
	}
	if(e.keyCode == 32 && app.gameState == app.GAMESTATE.gameOver)
	{
		app.pickedUp = [];
		app.pickedUpNear = [];
		app.circles = [];
		app.pickup = {row: 10, col: 15};
		app.init();
	}
});